...
const WA_MESSAGE = encodeURIComponent(
  "Hola, me gustaría recibir asesoría sobre llantas y productos para mi vehículo."
);
...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[80] flex items-center gap-3">
      {/* Tooltip */}
      <div
        className={`bg-[#0f0f10] text-white text-sm font-semibold px-4 py-2 rounded-full shadow-lg whitespace-nowrap transition-all duration-200 ${
